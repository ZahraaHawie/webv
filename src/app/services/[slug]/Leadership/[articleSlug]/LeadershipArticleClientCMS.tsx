...
export default function LeadershipArticleClientCMS({ article, serviceSlug }: Props) {
      ...
      <section data-theme="light" data-block="1" className="w-screen h-screen relative overflow-hidden bg-amber-50">
        <div className="w-full h-full flex">
          ...
          <div className="w-1/2 h-full flex flex-col justify-center p-16">
            ...
            {article.excerpt && (
              <p className="text-gray-700 max-w-lg mb-6" style={{ fontFamily: 'Lausanne', fontSize: 'clamp(16px, 1.2vw, 20px)', lineHeight: 1.6, fontWeight: 400 }}>
                {article.excerpt}
              </p>
            )}
          ...
          <div className="prose prose-lg max-w-none" style={{ fontFamily: 'Lausanne' }}>
            <PortableText 
              ...
              components={{
                block: {
                  normal: ({ children }) => (
                    <p className="mb-6 text-gray-800 leading-relaxed" style={{ fontSize: 'clamp(16px, 1.2vw, 20px)', lineHeight: 1.6 }}>
                      {children}
                    </p>
                  ),
                  h1: ({ children }) => (
                    <h1 className="text-4xl font-bold text-black mb-8 mt-12" style={{ fontFamily: 'Lausanne', lineHeight: 1.2 }}>
                      {children}
                    </h1>
                  ),
                  h2: ({ children }) => (
                    <h2 className="text-3xl font-bold text-black mb-6 mt-10" style={{ fontFamily: 'Lausanne', lineHeight: 1.2 }}>
                      {children}
                    </h2>
                  ),
                  h3: ({ children }) => (
                    <h3 className="text-2xl font-bold text-black mb-4 mt-8" style={{ fontFamily: 'Lausanne', lineHeight: 1.2 }}>
                      {children}
                    </h3>
                  ),
                  blockquote: ({ children }) => (
                    <blockquote className="border-l-4 border-gray-300 pl-6 italic text-gray-700 my-8" style={{ fontFamily: 'Ghost', fontSize: 'clamp(18px, 1.5vw, 24px)' }}>
                      {children}
                    </blockquote>
                  ),
                },
                ...
                types: {
                  image: ({ value }) => (
                    <div className="my-12">
                      ...
                      />
                      {value.alt && (
                        <p className="text-center text-gray-600 mt-4 italic" style={{ fontFamily: 'Lausanne', fontSize: 14 }}>
                          {value.alt}
                        </p>
                      )}
                    </div>
