...
export default function LeadershipArticleClient({ post }: Props) {
  const isMenuOpen = false; // Placeholder – header below uses static style

  return (
    <div className="min-h-screen bg-white">
      {/* Fixed Header (matches services/brand style, simplified without mega menus) */}
      <motion.div 
          ...
          <nav className="hidden md:flex items-center gap-6 lg:gap-8">
            {['Industries', 'Services', 'Work', 'Ideas', 'Profile'].map((item) => (
              <motion.button key={item}
                className={`font-medium tracking-wide transition-colors duration-200 ${item==='Ideas'?'text-black':'text-black/80 hover:text-black'}`}
        ...
        <div className="fixed left-0 right-0 top-[var(--header-h)] z-40 bg-white shadow-xl h-[calc(100vh-72px-100px)] overflow-hidden">
          <div className="w-full h-full flex">
            <div className="w-80 bg-black h-full flex flex-col overflow-auto">
              <div className="p-6"><button className="text-white text-2xl font-light hover:text-gray-300 transition-colors" /></div>
              <div className="h-10" />
         ...
         <div className="mx-auto w-full max-w-[1400px] px-6 md:px-10 lg:px-16">
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
             ...
             <div className="lg:col-span-1">
               ...
               >
                 {/* Custom icon */}
                 {/* Combined icon + metadata container */}
<div className="w-full max-w-sm mb-8 mt-48">
  ...
  {/* Metadata rows */}
  <MetaRow label="Date" value={new Date(post.publishedAt).toLocaleDateString('en-US', { 
    day: 'numeric', 
    month: 'short', 
    year: 'numeric' 
  })} />
  <MetaRow label="Category" value={post.type || post.tag} />
  <MetaRow label="Writer" value={post.writer} />
                 ...
                 <div className="w-full max-w-sm mt-15">
                   ...
                   <div className="flex items-center gap-3">
                     ...
                     {/* <CircleBtn ariaLabel="Share to Instagram">
      <InstagramIcon />
    </CircleBtn> */}
      ...
      <section className="w-full bg-white py-16 lg:py-24">
        ...
        <div className="mx-auto w-full max-w-[900px] px-6 md:px-10 lg:px-16">
          ...
          >
            {/* Article Content - 7 Paragraphs with Optional Images and Videos */}
            {[
                  ...
                  <div className="my-8">
                    <div className="relative w-full" style={{ paddingBottom: '56.25%' }}> {/* 16:9 aspect ratio */}
                      {section.video.includes('youtube.com') || section.video.includes('youtu.be') ? (
                        <iframe
                          src={formatVideoUrl(section.video) + '?autoplay=1&loop=1&playlist=' + getYouTubeVideoId(section.video) + '&controls=0&mute=1&playsinline=1'}
                          title="Video"
                        ...
                        <iframe
                          src={formatVideoUrl(section.video) + '?autoplay=1&loop=1&controls=0&muted=1&background=1'}
                          title="Video"
                          className="absolute top-0 left-0 w-full h-full rounded-lg"
                          frameBorder="0"
                          allowFullScreen
                  ...
                  <div className="my-8">
                    <div className="relative w-full h-[400px]">
                      <Image
                        ...
                        alt={`Article image ${section.number}`}
                        fill
  ...
  return (
    <div className="flex items-center justify-between py-3 border-b border-gray-200">
      ...
      <span
        ...
        style={{ fontFamily: 'Lausanne', fontSize: 14, fontWeight: 600 }}
      >
        {value}
      </span>
    </div>
...
/* icons (monotone to match your UI) */
